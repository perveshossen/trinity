        ...
        <div class="row">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <img style="height: 50px; width: 50px;" src="{{ asset('uploads/memoriae_photo') }}/{{ $memory->photo }}" alt="">
                            </td>
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <a href="{{ route('memoriae.show', $memory->id) }}" class="btn btn-info">Update</a>
                                    <form action="{{ route('memoriae.destroy', $memory->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
            ...
            <div class="col-lg-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('memoriae.store') }}" enctype="multipart/form-data">
                            @csrf
