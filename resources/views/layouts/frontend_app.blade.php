...
<head>
    ...
    <!-- Jarallax Assets -->
    <link href="{{ asset('frontend_asset') }}/jaralax-asstes/css/demo.css" rel="stylesheet">
    <link href="{{ asset('frontend_asset') }}/jaralax-asstes/js/jarallax.css" rel="stylesheet">

    <!-- Object Fit polyfill -->
    <script src="https://unpkg.com/object-fit-images/dist/ofi.min.js"></script>
    <script src="{{ asset('frontend_asset') }}/jaralax-asstes/js/jarallax.js"></script>
    <script src="{{ asset('frontend_asset') }}/jaralax-asstes/js/jarallax-video.js"></script>
</head>
...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 m-auto text-center">
                    <a href="{{ route('index') }}"> <img src="{{ asset('uploads/logo') }}/{{ $logo->logo }}" alt="{{ $logo->logo }}"> </a>
                </div>
            </div>
        </div>
    </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg">
        <div class="container">
            <a class="navbar-brand" href="{{ route('index') }}"> <img src="{{ asset('uploads/logo') }}/{{ $logo->logo }}" alt="{{ $logo->logo }}"> </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav m-auto">
                    <li class="nav-item">
                        <a class="nav-link @yield('index') " href="{{ route('index') }}">HOME
                    ...
                    <li class="nav-item">
                        <a class="nav-link @yield('getway') " href="{{ route('gateway') }}">GETAWAYS</a>
                    </li>
                    <li class="nav-item">
    ...
    <section class="responsive-navbar">
        ...
        <div id="sidebarMenu">
            <ul class="sidebarMenuInner">
                <li><a class=" @yield('index') " href="{{ route('index') }}">Home</a></li>
                <li><a class=" @yield('history') " href="{{ route('history') }}">HISTORY</a></li>
                <li>
                    <a class=" @yield('publication') " href="{{ route('publication') }}">PUBLICATIONS</a>
                </li>
                <li>
                    <a  @yield('still')  href="{{ route('still') }}">STILL</a>
                </li>
                <li>
                    <a  @yield('service')  href="{{ route('service') }}">SERVICES</a>
                </li>
                <li>
                    <a  @yield('shop')  href="{{ route('shop') }}">SHOP</a>
                </li>
                <li>
                    <a  @yield('insider')  href="{{ route('insider') }}">INSIDER</a>
                </li>
                <li>
                    <a  @yield('getway')  href="{{ route('gateway') }}">GETAWAYS</a>
                </li>
                <li>
                    <a  @yield('contact')  href="{{ route('contact') }}">Contact</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-12 m-auto text-center follow-icons">
                <ul>
                    ...
                    <li><a href="{{ $social->link }}" target="_blank" class="social-icons"><i class="{{ $social->icon }}"></i></a></li>
                    @endforeach
